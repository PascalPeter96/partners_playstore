...
class NearbyDeliveryLocationMapScreen extends StatefulWidget {
  final double userDistance;
  final NearbyJobs nearbyJobs;
  const NearbyDeliveryLocationMapScreen({Key? key, required this.nearbyJobs, required this.userDistance}) : super(key: key);

  @override
  State<NearbyDeliveryLocationMapScreen> createState() => _NearbyDeliveryLocationMapScreenState();
}

class _NearbyDeliveryLocationMapScreenState extends State<NearbyDeliveryLocationMapScreen> {
  ...
  void initState() {
    ...
    getTime(widget.nearbyJobs.latitude, widget.nearbyJobs.longitude);

    storeLocation = LatLng(widget.nearbyJobs.latitude, widget.nearbyJobs.longitude);
