...
class DeliveryVerifyOtp extends StatefulWidget {
  final String phone;
  const DeliveryVerifyOtp({Key? key, required this.phone}) : super(key: key);

  @override
  State<DeliveryVerifyOtp> createState() => _DeliveryVerifyOtpState();
}

class _DeliveryVerifyOtpState extends State<DeliveryVerifyOtp> {
