...
class DeliveryLocationScreen extends StatefulWidget {
  ...
  const DeliveryLocationScreen({Key? key, required this.deliveryOrder}) : super(key: key);
                    ...
                    children: [
                      ...
                      Card(
                        ...
                        child: ListTile(
                          ...
                          title: Text(widget.deliveryOrder.name,
                            style: AppTheme.sectionMediumBoldTitle,
                          ),
                          subtitle: AppSub(sub: widget.deliveryOrder.location),
                          trailing: Container(
                            width: 20.w,
                            child: Row(
