...
class _GFMultiSelectState<T> extends State<GFMultiSelect<T>>
  ...
  void initState() {
    if (widget.initialSelectedItemsIndex != null &&
      ...
      for (int x in widget.initialSelectedItemsIndex!) {
        _selectedTitles.add(widget.items[x].name);
  ...
  void _onItemSelect(bool selected, int index) {
    if (selected == true) {
      setState(() {
        _selectedTitles.add(widget.items[index].name);
        _selectedTitlesIndex.add(index);
      });
    } else {
      setState(() {
        _selectedTitles.remove(widget.items[index].name);
                    ...
                    children: List.generate(
                        widget.items.length,
                          ...
                          value: _selectedTitles
                              .contains(widget.items[index].name),
                          ...
                          titleText: widget.items[index].name,
                          color: widget.color,
