...
import 'package:wena_partners/professional/screens/auth/professional_phone_otp.dart';
...
class ProfessionalPhoneLogin extends StatefulWidget {
  const ProfessionalPhoneLogin({Key? key}) : super(key: key);

  @override
  State<ProfessionalPhoneLogin> createState() => _ProfessionalPhoneLoginState();
}

class _ProfessionalPhoneLoginState extends State<ProfessionalPhoneLogin> {
    ...
    return  Scaffold(
      ...
      bottomNavigationBar: Row(
        ...
        children: [
          ...
          TextButton(
              onPressed: (){
                Get.off(() => ProfessionalSignUpScreen());
              },
                      ...
                      child: AppButton(
                        ...
                        function: () {
                          ...
                          if(_formKey.currentState!.validate()){
                            ...
                            print(countryCode.dialCode +mobileCont.text.trim());
                            Get.off(() => ProfessionalVerifyOtp(phone: countryCode.dialCode + mobileCont.text.trim()));
                          }   else {
                            print('Failed');
