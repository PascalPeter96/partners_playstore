...
import 'package:wena_partners/professional/screens/auth/privacy_policy_screen.dart';
...
class _ProfessionalSignUpScreenState extends State<ProfessionalSignUpScreen> {
  ...
  final TextEditingController chargeRateCont = TextEditingController();
  ...
  final List<String> chargeType = [
    'Per hour', 'Per day', 'Per week', 'Per project'
  ];
  ...
  late String selectedProfessionalValue;
  ...
  late CountryCode professionalCountryCode;
  ...
  String vehicleError = '';
  String profileError = '';
  String professionalFrontError = '';
  String professionalBackError = '';
  String kinFrontError = '';
  String kinBackError = '';

  File? vehicleImage;
  File? profileImage;
  File? professionalFrontImage;
  File? professionalBackImage;
  File? kinFrontImage;
  File? kinBackImage;
  ...
  pickProFrontImage() async {
    try{
      final image = await ImagePicker().pickImage(source: ImageSource.gallery);
      if(image == null) return;
      final tempImage = File(image.path);
      setState((){
        professionalFrontImage = tempImage;
      });
    } on PlatformException {
      print('Failed to Pick Image');
    }
  }
  pickProBackImage() async {
    try{
      final image = await ImagePicker().pickImage(source: ImageSource.gallery);
      if(image == null) return;
      final tempImage = File(image.path);
      setState((){
        professionalBackImage = tempImage;
      });
    } on PlatformException {
      print('Failed to Pick Image');
    }
  ...
  final chargeRateValidator = MultiValidator([
    RequiredValidator(errorText: 'Charge rate is required'),
  ]);

  final experienceValidator = MultiValidator([
  ...
  final accNumberValidator = MultiValidator([
    ...
    MaxLengthValidator(15, errorText: 'Account number too long'),
  ]);
  ...
  void initState() {
    ...
    professionalCountryCode = CountryCode(name: 'Uganda', code: 'UG', dialCode: '+256');
    ...
    selectedProfessionalValue = 'Individual';
  }
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: RadioListTile(
                                      ...
                                      value: 'Individual',
                                      groupValue: selectedProfessionalValue.toString(),
                                      onChanged: (value){
                                        setState((){
                                          selectedProfessionalValue = value as String;
                                        });
                                      },
                                ...
                                prefixIcon: Padding(
                                  ...
                                  child: Bounceable(
                                    onTap: () async {
                                      ...
                                      setState((){
                                        professionalCountryCode = code!;
                                      });
                                      print(professionalCountryCode);
                                    },
                                    child: Container(
                                      width: 30.w,
                                      child: Row(
                                        ...
                                        children: [
                                          professionalCountryCode.flagImage,
                                          Container(
                                            child: Text(professionalCountryCode.dialCode ),
                                          ),
                          ...
                          categoryError=='' ?  Container() : Padding(
                            padding: EdgeInsets.symmetric(horizontal: 3.w, vertical: 0.5.h),
                            child: Text(categoryError, style: TextStyle(
                              fontSize: 14.sp,
                              color: Colors.red.shade800,
                          ...
                          subCategoryError =='' ?  Container() : Padding(
                            padding: EdgeInsets.symmetric(horizontal: 3.w, vertical: 0.5.h),
                            child: Text(subCategoryError, style: TextStyle(
                              fontSize: 14.sp,
                              color: Colors.red.shade800,
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: DropdownButton2(
                                    ...
                                    onChanged: (value) {
                                      setState(() {
                                        selectedChargeType = value as String;
                                      });
                                    },
                                    // buttonHeight: 40,
                                    // buttonWidth: 140,
                              ...
                              chargeTypeError=='' ?  Container() : Padding(
                                padding: EdgeInsets.symmetric(horizontal: 3.w, vertical: 0.5.h),
                                child: Text(chargeTypeError, style: TextStyle(
                                  fontSize: 14.sp,
                                  color: Colors.red.shade800,
                          ...
                          Text('Professional\'s National ID', style: AppTheme.sectionMediumTitle,),
                          SizedBox(
                            height: 1.h,
                          ),
                            ...
                            children: [
                              Column(
                                children: [
                                      ...
                                      child: Center(
                                        child: ClipRRect(
                                          ...
                                          child: SizedBox(
                                              height: 20.h,
                                              width: 43.w,
                                              child: professionalFrontImage != null?
                                              Image.file(File(professionalFrontImage!.path.toString()),fit: BoxFit.cover,):
                                              Container(
                                                decoration: BoxDecoration(
                                                  color: AppTheme.borderColor2,
                                                  borderRadius: BorderRadius.circular(15.sp),
                                  ...
                                  professionalFrontError=='' ?  Container() : Padding(
                                    padding: EdgeInsets.symmetric(horizontal: 3.w, vertical: 0.5.h),
                                    child: Text(professionalFrontError, style: TextStyle(
                                      fontSize: 14.sp,
                                      color: Colors.red.shade800,
                              ...
                              Column(
                                children: [
                                      ...
                                      child: Center(
                                          child: ClipRRect(
                                            ...
                                            child: SizedBox(
                                              height: 20.h,
                                              width: 43.w,
                                              child: professionalBackImage != null?
                                              Image.file(File(professionalBackImage!.path.toString()),fit: BoxFit.cover,):
                                              Container(
                                                decoration: BoxDecoration(
                                                    color: AppTheme.borderColor2,
                                  ...
                                  professionalBackError=='' ?  Container() : Padding(
                                    padding: EdgeInsets.symmetric(horizontal: 3.w, vertical: 0.5.h),
                                    child: Text(professionalBackError, style: TextStyle(
                                      fontSize: 14.sp,
                                      color: Colors.red.shade800,
                          ...
                          selectedProfessionalValue == 'Individual' ? Container() : SizedBox(
                            height: 2.h,
                          ),
                          selectedProfessionalValue == 'Individual' ? Container() : Text('Company', style: AppTheme.sectionMediumTitle,),
                          selectedProfessionalValue == 'Individual' ? Container() : SizedBox(
                            height: 1.h,
                          ),

                          selectedProfessionalValue == 'Individual' ? Container() : Container(
                            clipBehavior: Clip.antiAlias,
                            width: 90.w,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(15.sp)
                          ...
                          AppButton(
                            ...
                            function: (){
                              ...
                              if(_formKey.currentState!.validate()){
                                ...
                                setState((){
                                  categoryError = 'district required';
                                });
                                ...
                                print(professionalCountryCode.dialCode);
                                print(phoneCont.text.trim());
                                print(professionalCountryCode.dialCode +phoneCont.text.trim());
