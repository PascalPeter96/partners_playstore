...
class StoreBranchProductsRepository {


  static var client = http.Client();

  Future<List<StoreBranchProduct>?> fetchStoreBranchProducts(String? token) async {
    ...
    if(response.statusCode == 200) {
      print(response);
      print(data);
      return data.map((e) => StoreBranchProduct.fromJson(e)).toList();
    } else {
      return null;
    }
