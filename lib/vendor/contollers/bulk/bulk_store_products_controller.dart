...
import 'package:wena_partners/vendor/models/bulk/add_bulk_store_product_model.dart';
...
class BulkStoreProductsController extends GetxController {
  ...
  addBulkProduct(String orderUnit, int prepTime, String prepTimeUnit,
      int price, String prodVariantId, String storeBranchId, int moq
      ) async{
    isAddLoading(true);

    AddBulkStoreProductModel addBulkStoreProductModel = AddBulkStoreProductModel(
    ...
    var response = await NetworkHandler.post(addBulkStoreProductModelToJson(addBulkStoreProductModel), 'store/products/bulk-products', userStorage.read('vendorAccessToken'));
